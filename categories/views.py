...
def deepdive_page_single(request, category_slug, indicator_id):
    return page(request=request, category_slug=category_slug, page_type='deepdive_single', indicator_id=indicator_id)


def page(request, category_slug, page_type, indicator_id=None):
    ...
    elif (page_type == 'deepdive_single'):
